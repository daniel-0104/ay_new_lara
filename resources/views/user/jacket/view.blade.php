            ...
            <form action="">
                <div class="row align-items-center justify-content-center mx-auto pb-4">
                    <div class="col-lg-5 col-md-5">
                        <img src="{{ asset('storage/'.$jackets->image) }}" class="w-100 d-block">
                    </div>
                    ...
                    <div id="product-details">
                        <div class="mb-2">
                            <label for="">Type : <span>{{ $jackets->type }}</span></label>
                            <label for="">Color : <span>{{ $jackets->color }}</span></label>
                            <label for="">Price : <span>{{ $jackets->price }} Kyats </span></label>
                            <label>Size : <span> {{ $jackets->size }} </span></label>
                            <label for="">Viewers : <span> {{ $jackets->view_count }} </span></label>
                        </div>
                        <p style="font-family: calibri;">{{ $jackets->description }}</p>
                    </div>
                        <div class="mb-4 pt-2" id="order-count-btn" >
                            <div class="input-group quantity me-3" style="width: 130px;">
                                ...
                                <input type="hidden" value="{{ $jackets->name }}" id="jacketName">
                                <div class="input-group-btn">
    ...
    <section id="related-product" class="my-5 px-5">
        ...
        <div class="swiper mySwiper" id="mySwiper">
            <div class="swiper-wrapper">
                    @foreach ($jacketLists as $j)
                    <div class="swiper-slide">
                        <input type="hidden" class="userId" value="{{ Auth::user()->id }}">
                        <input type="hidden" class="productName" value="{{ $j->name }}">
                        <input type="hidden" class="orderCount" value="1">
                        <div id="product-img-content">
                            <img src="{{ asset('storage/'.$j->image) }}" class="w-100 d-block" style="height: 290px;">
                            <div id="product-img-link">
                                <a href="{{ route('user#jacketView',$j->id) }}" id="eye"><i class="fa-solid fa-eye"></i></a>
                        ...
                        <div id="product-name" class="product-name mt-2 border px-1 py-2 text-center">
                            <h5>{{ $j->name }}</h5>
                            <div id="pro-label">
                                <label for="">{{ $j->type }}</label>
                                <span style=" color: #a2b2ee;"> {{ $j->price }} Kyats </span>
                            </div>
                        </div>
                    </div>
                    @endforeach
...
<script>
    ...
    // load more data
    var ENDPOINT = "{{ route('user#jacketView',$jackets->id) }}" ;
    var page = 1;

                    ...
                    <div class="col-lg-6 col-md-6 mt-3">
                        ...
                        <div id="product-details">
                            <div class="mb-2">
                                ...
                                <label>Viewers : <span>{{ $products->view_count }}</span></label>
                                <div id="size-check">
                        ...
                        <div class="mb-4 pt-2" id="order-count-btn" >
                            <div class="input-group quantity me-3" style="width: 130px;">
                                ...
                                <input type="hidden" id="productName" value="{{ $products->name }}">
                                <div class="input-group-btn">
        ...
        <div id="details-show">
            ...
            <div id="reviews-info" class="px-4 mt-3 mx-auto">
                <div>
                    ...
                    <div id="rev-dropdown">
                        <div id="rev-toggle" class="mt-5 mb-3 d-flex align-items-center border border-1 w-50 py-2 justify-content-center">
                ...
                @foreach ($productList as $p)
                    <div class="swiper-slide">
                        ...
                        <div id="product-name" class="mt-2 border px-1 py-1 text-center">
                            <h5>{{ $p->name }}</h5>
                            <div id="pro-label">
                                <label for="">{{ $p->category_name }}</label>
                                <span style=" color: #a2b2ee;">{{ $p->price }} Kyats</span>
                            </div>
                        </div>
                    </div>
                @endforeach
...
<script>
    $(document).ready(function(){
        $('.btn-minus').click(function(event){
            ...
            var currentValue = parseInt($('#orderCount').val());
            if(currentValue > 1){
    ...
    var ENDPOINT = "{{ route('detail#view',$products->id) }}";
    var page = 1;
